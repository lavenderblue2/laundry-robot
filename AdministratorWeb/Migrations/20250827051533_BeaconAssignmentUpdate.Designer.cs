...
namespace AdministratorWeb.Migrations
{
    ...
    [Migration("20250827051533_BeaconAssignmentUpdate")]
    partial class BeaconAssignmentUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdministratorWeb.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("AssignedBeaconId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdministratorWeb.Models.ApplicationUser", b =>
                {
                    b.HasOne("AdministratorWeb.Models.BluetoothBeacon", "AssignedBeacon")
                        .WithMany("AssignedUsers")
                        .HasForeignKey("AssignedBeaconId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("AssignedBeacon");
                });
